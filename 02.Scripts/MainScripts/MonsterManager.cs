...
public class MonsterManager : MonoBehaviourPun, IPunObservable
{
    ...
    //[Header("Monster Create Count")]
    //public int count;
    //private int currentIndex;

    //[Header("Crate Delay")]
    //public float createTime;
    //private WaitForSeconds createDelay;
    ...
    //    createDelay = new WaitForSeconds(createTime);
    ...
    //            monster,
    //            transform);
    //        //pool[i] = PhotonNetwork.Instantiate(
    //        //    monster.name, 
    //        //    transform.position,
    //        //    transform.rotation);
    ...
    //[PunRPC]
    //private void GetMonster(Vector3 pos, Quaternion rot)
    //{
    //    if (pool[currentIndex].activeSelf)
    //    {
    //        Debug.LogError("몬스터 수 모자람");
    //        return;
    //    }
    //    if (pool[currentIndex].activeSelf)
    //        return;

    //    pool[currentIndex].transform.position = pos;
    //    pool[currentIndex].transform.rotation = rot;
    //    pool[currentIndex].SetActive(true);

    //    MonsterAI ma = pool[currentIndex].GetComponent<MonsterAI>();
    //    //ma.StartAI();
    //    //pool[currentIndex].GetComponent<PhotonView>().RPC("StartAI",RpcTarget.All);
    ...
    //            //pv.RPC("GetMonster", RpcTarget.All, spawnPos[ran].position, spawnPos[ran].rotation);
    //            //GetMonster(spawnPos[ran].position, spawnPos[ran].rotation);
    //        }
    //        yield return createDelay;
    //    }
    //}
    ...
    //----------------------------------------------------------------------------------------------------
    //public MonsterAI enemyPrefab; // 생성할 적 AI
    ...
    //private List<MonsterAI> enemies = new List<MonsterAI>(); // 생성된 적들을 담는 리스트
    ...
    //    MonsterAI enemy = createdEnemy.GetComponent<MonsterAI>();
